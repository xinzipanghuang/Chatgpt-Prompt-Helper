...
async function build() {
    ...
    const commonFiles = [
        ...
        { src: 'public/icon.png', dst: 'images/icon.png' },
        { src: 'public/32x32.png', dst: 'images/32x32.png' },
        { src: 'public/128x128.png', dst: 'images/128x128.png' },
        { src: 'src/background.js', dst: 'background.js' },
        { src: 'src/content.js', dst: 'content.js' },
